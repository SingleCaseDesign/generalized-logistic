...
In this example, we will use the data from Singh (2007). This is included in the userfriendlyscience R package, and can be loaded by using the `data` function:
